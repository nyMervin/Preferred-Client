...
class Time_deposit_queries extends CI_Controller{
    ...
    public function all()
    {
        ...
        $this->data['list'] = $this->admin_panel_model->get_all_time_deposit();
    ...
    public function query_by_date()
    {
        ...
        $this->data['page']='query_all';
        $this->data['list'] = $this->admin_panel_model->get_all_time_deposit_date_filter($from_date,$to_date);
        $this->load->vars($this->data);
        $this->load->view($this->data['theme'].'/template');
    }
    public function query_by_date_branch()
    {
        ...
        $this->data['page']='query_branch';
        $this->data['branches'] = $this->admin_panel_model->get_branches();
        $this->data['list'] = $this->admin_panel_model->get_time_deposit_date_branch_filter($branch,$from_date,$to_date);
        $this->load->vars($this->data);
        $this->load->view($this->data['theme'].'/template');
    }
