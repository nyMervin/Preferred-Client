<div class="tab-content">
               <div class="tab-pane hidan active">
					...
					<div class="col-md-8 col-md-offset-2">
						<div class="rate-ex">
							<form class="custom-input qrytrs" method="POST" action="<?php echo base_url().'admin/fixed-income-queries-by-branch' ;?>">
								<div class="form-control areaa">
									<div class="col-md-3" style="padding:0px;"><label class="arealabel">From</label></div>
									<div class="col-md-9" style="padding:0px;">
										<input type="text"  name="from" placeholder="yyyy-mm-dd" id="datepicker" autocomplete="off">
									</div>
								</div>
								<div class="form-control areaa">
									<div class="col-md-3" style="padding:0px;"><label class="arealabel">To</label></div>
									<div class="col-md-9" style="padding:0px;">
										<input type="text"  name="to" placeholder="yyyy-mm-dd" id="datepicker2" autocomplete="off">
									</div>
								</div>
