<div class="tab-content">
               <div class="tab-pane hidan active">
					<div class="col-md-12 text-center">
						<h2>Query and "Buy Dollar" & "sell Dollar" By a Depositor</h2>
						<h2>&nbsp;</h2>
					</div>
					<div class="col-md-8 col-md-offset-2">
						<div class="rate-ex">
							<form class="custom-input qrytrs" method="POST" action="<?php echo base_url(); ?>admin/sell-dollar-query-by-depositor">
								<div class="form-control">
									<div class="col-md-3"><label style="width: auto;">Depositor</label></div>
									<div class="col-md-9">
										<input type="text" name="app_user" value="<?php echo(@$this->input->post('app_user'))?>" id="app_user" autocomplete="off">
									<ul class="list-gpfrm" id="app_user_search" style="left: auto;top: 68%;z-index: 9999;"></ul>
