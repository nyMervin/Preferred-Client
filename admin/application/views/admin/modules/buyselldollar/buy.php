...
<div class="tab-content">
  ...
  <div class="newcss">
          ...
          <!-- <form action="<?php //echo base_url(); ?>admin/transaction/set_buy_dollar_transaction"  method="POST"> -->
          <form class="buy_dollar_t"  method="POST">
              <input type="number" id="transaction_number<?php echo $item['id'];?>" name="transaction_number" required=""/>
                <input type="hidden" id="id<?php echo  $item['id'] ?>" name="id<?php echo  $item['id'] ?>" value="<?php echo $item['id'];?>">
                ...
                <button class="btn bthhn bd_btn" id="<?php echo $item['id'];?>" type="submit" name="submit">Send</button></div>              
              </form>
