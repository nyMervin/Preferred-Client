            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-8 col-md-7 col-text-center">
                        <div class="enter-box">
                            <?php  if($this->session->flashdata('message_deativated')) {  ?>
                        <div class="alert alert-warning"><?php echo $this->session->flashdata('message_deativated');?></div>
                        <?php  } ?>
                            <?php  if($this->session->flashdata('message')) {  ?>
                        <div class="alert alert-danger"><?php echo $this->session->flashdata('message');?></div>
                        <?php  } ?>
                            <form action="" class="custom-input m-t-20" id="admin_login" method="post">
                                <div class="form-control form-group">
                                    <label>Branch:</label>
                                    <input type="text" class="form-control" name="branch" id="branch" placeholder="Branch"/>
                                </div>
                                <div id="wait" style="display:none;width:69px;height:89px;position:absolute;left:44%;padding:2px;z-index: 10;"><img src='https://www.influencerondemand.com/assets/images/wait.gif' width="64" height="64" /><br>Please Wait..</div>
                                <div class="form-control form-group">
