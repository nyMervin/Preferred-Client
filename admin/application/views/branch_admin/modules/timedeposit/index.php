<div class="tab-content">
        ...
        <?php } ?>
            ...
            <div class="col-md-4">Reply: Hi <?php echo $item['first_name'];?>! Transaction Completed.</div><div class="col-md-2">TD Placement : ₱<?php echo $item['amount'];?></div><div class="col-md-2" style="padding: 0;">Transaction Number:</div><div class="col-md-4"> 
               ...
               <!--<form action="<?php echo base_url(); ?>branchadmin/transaction/set_time_deposit_transaction"  method="POST">-->
              ...
              <input type="text" id="transaction_number<?php echo $item['id'];?>" name="transaction_number" required />
                ...
                <button class="btn bthhn td_btn" type="submit" id="<?php echo $item['id'];?>" name="submit">Send</button></div>              
              </form>
