<div class="tab-content">
          ...
          <?php } ?>
                    ...
                    <div class="wt__br rtl-lefy">
                        ...
                        <div class="col-md-4 bsdo__">In-Message: Buy <?php echo $item['credit_peso'];?> at 52.60/$1</div><div class="col-md-4 bsdo__">Debit My Dollar Account $<?php echo $item['amount'];?></div><div class="col-md-4 bsdo__">Credit my Peso Account <?php echo $item['credit_peso'];?></div>
						<div class="col-md-4">Reply: Hi <?php echo $item['first_name']; ?>! Transaction Completed.</div><div class="col-md-2">Bought <?php echo $item['credit_peso'];?></div><div class="col-md-2" style="padding: 0;">Transaction Number:</div><div class="col-md-4">

              <!--<form action="<?php echo base_url(); ?>branchadmin/transaction/set_sell_dollar_transaction"  method="POST">-->
			  ...
			  <input type="text" id="transaction_number<?php echo $item['id'];?>" name="transaction_number" required="" />
                ...
                <input type="hidden" id="credit_peso<?php echo  $item['id'] ?>" name="credit_peso" value="<?php echo $item['credit_peso'];?>">
                <input type="hidden" id="debit_dollar<?php echo  $item['id'] ?>" name="debit_dollar" value="<?php echo $item['amount'];?>">
			<!--	
              <input type="text" name="transaction_number"/>
                <input type="hidden" name="id" value="<?php echo $item['id'];?>">
                <input type="hidden" name="client_id" value="<?php echo $item['client_id'];?>">
                <input type="hidden" name="credit_peso" value="<?php echo $item['credit_peso'];?>">
                <input type="hidden" name="debit_dollar" value="<?php echo $item['amount'];?>">-->
                <button class="btn bthhn sd_btn" type="submit" id="<?php echo $item['id'];?>" name="submit">Send</button></div>              
              </form>
